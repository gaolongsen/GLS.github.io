...
1. **Polytope $$\mathcal{X}_0$$**:
   ...
   - $$\mathcal{X}_0 = \{ x \in \mathbb{R}^n \mid H_x x \leq 1 \}$$: This is a polytope in $$\mathbb{R}^n$$ defined by a set of linear inequalities.
   - Vertices $$\{x^1, \ldots, x^v\}$$: The polytope $$\mathcal{X}_0$$ is characterized by its vertices $$x^1, x^2, \ldots, x^v$$.
