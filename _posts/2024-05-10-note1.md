...
2. **Minkowski Sum Representation**:
   - The set $$\mathcal{X}_{l|k}$$ is described as a Minkowski sum, which combines a central point $$z_{l|k}$$ and a scaled version of the original polytope ![](https://latex.codecogs.com/svg.image?\mathcal{X}_0&space;).
